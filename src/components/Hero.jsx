      ...
      <div className="hero-container">
        ...
        >
          ...
          <motion.div className="social-links" variants={staggerContainer}>
            <motion.a
              href="https://www.linkedin.com/in/marwan-fahmy-085093238/"
              target="_blank"
            >
              <i className="fab fa-linkedin"></i>
            </motion.a>
            <motion.a href="https://github.com/Maro7772" target="_blank">
              <i className="fab fa-github"></i>
            </motion.a>
            <motion.a href="https://x.com/MarwanFahmy7772" target="_blank">
